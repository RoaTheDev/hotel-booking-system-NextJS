...
export const AmenitiesClientPage = () => {
    ...
    <div className="floating-element floating-1 absolute top-20 left-10 w-32 h-32 bg-gradient-to-br from-amber-500/10 to-orange-500/10 rounded-full blur-xl"></div>
        ...
        <div className="floating-element floating-3 absolute bottom-40 left-1/4 w-40 h-40 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-full blur-2xl"></div>
        </div>
    ...
    <Image
        src="/placeholder.svg?height=600&width=1920&text=Dark mountain wellness facilities with warm lighting"
    alt="Mountain wellness facilities"
    fill
    ...
    <h1 className="text-4xl md:text-6xl font-light text-slate-100 mb-6 leading-tight tracking-wide">
        ...
        Discover our thoughtfully curated facilities designed to nurture your body, mind, and spirit in the tranquil
    ...
    <h2 className="text-3xl md:text-4xl font-light text-slate-100 mb-4 tracking-wide">Sanctuary Facilities</h2>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {amenities.map((amenity) => {
                ...
                <div className="amenity-icon w-10 h-10 bg-gradient-to-br from-amber-500 to-orange-500 rounded-full flex items-center justify-center shadow-lg">
    ...
    {/* CTA Section */}
    <section ref={ctaRef} className="py-20 bg-gradient-to-r from-slate-800 to-slate-700 relative overflow-hidden">
    ...
    <p className="text-xl text-slate-300 mb-8 leading-relaxed font-light max-w-2xl mx-auto">
        Book your stay and enjoy unlimited access to all our wellness facilities. Your journey to rejuvenation and
