        ...
        <div ref={containerRef} className="min-h-screen bg-slate-900 text-slate-100 relative overflow-hidden">
            ...
            <section ref={heroRef} className="relative py-20 overflow-hidden">
                <div className="absolute inset-0 z-0">
                    ...
                    />
                    <div
                        className="absolute inset-0 bg-gradient-to-b from-slate-900/60 via-slate-900/40 to-slate-900/90"/>
                </div>
                ...
                <div className="hero-content relative z-10 text-center max-w-4xl mx-auto px-4">
                    ...
                    <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-2xl mx-auto leading-relaxed font-light">
                        Savor the essence of the mountains through carefully crafted dishes that honor seasonal
                        ingredients and
                        traditional techniques
                    </p>
                    <div
                        className="w-24 h-px bg-gradient-to-r from-transparent via-amber-400 to-transparent mx-auto"></div>
                </div>
            </section>
            ...
            <section ref={experiencesRef} className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative z-10">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-light text-slate-100 mb-4 tracking-wide">Culinary
                        Journeys</h2>
                    <div
                            ...
                            >
                                <div className="relative h-48 overflow-hidden">
                                    ...
                                    <div className="absolute top-4 right-4">
                                        <div
                                            className="flex items-center gap-1 bg-slate-800/80 backdrop-blur-sm px-2 py-1 rounded border border-slate-700/50">
                                            <Star className="h-3 w-3 fill-amber-400 text-amber-400"/>
                                            <span
                                                className="text-amber-400 text-sm font-medium">{experience.rating}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <CardContent className="experience-content p-6">
                                    <div className="flex items-center gap-3 mb-3">
                                        <div
                                            className="experience-icon w-10 h-10 bg-gradient-to-br from-amber-500 to-orange-500 rounded-full flex items-center justify-center shadow-lg">
            ...
            <section ref={menuRef} className="py-20 bg-slate-800/30 backdrop-blur-sm">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="menu-content text-center mb-16">
                        <h2 className="text-3xl md:text-4xl font-light text-slate-100 mb-4 tracking-wide">Signature
                            Dishes</h2>
                        <div
                            className="w-16 h-px bg-gradient-to-r from-transparent via-amber-400 to-transparent mx-auto mb-8"></div>
                        <p className="text-xl text-slate-300 leading-relaxed font-light max-w-2xl mx-auto">
            ...
            <section className="py-20 bg-gradient-to-r from-slate-900 to-slate-800">
                <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                    <h2 className="text-4xl md:text-5xl font-light mb-6 tracking-wide text-slate-100">Culinary
                        Philosophy</h2>
