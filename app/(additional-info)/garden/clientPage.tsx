                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        <Link href="/" className="flex items-center space-x-3">
                            <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-green-500 rounded-sm flex items-center justify-center shadow-lg">
                        ...
                        <div className="flex items-center space-x-4">
                            <Link href="/">
                                <Button
                                    variant="ghost"
                                    className="text-slate-300 hover:bg-slate-800 hover:text-emerald-400 transition-all duration-300"
                                >
                                    Back to Home 
                                </Button>
                            </Link>
                            <Link href="/booking">
                                <Button className="bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600 text-slate-900 shadow-lg hover:shadow-emerald-500/25 transition-all duration-300 hover:scale-105">
                                    Book Garden Tour
                                </Button>
                            </Link>
                        </div>
