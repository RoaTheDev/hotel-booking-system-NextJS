...
export default function ClientRoomDetail({ room }: { room: RoomWithDetails }) {
          ...
          <div className="lg:col-span-2">
            <div className="gallery-content space-y-4">
              <div className="relative h-96 rounded-lg overflow-hidden">
                <Image
                  src={room.images[selectedImage]?.imageUrl || "/placeholder.svg"}
                  alt={room.images[selectedImage]?.caption || `${room.roomType.name} - Image ${selectedImage + 1}`}
                  fill
